...
class SaleSummaryChart extends Component {
    getHeaderTitle = (props) => {
        const { item, ON_CLOSE_MARKER } = props
                    ...
                    <Layout style={{ backgroundColor: '#FFF', margin: '10px 10px 5px 10px', backgroundColor: '#f0f2f5' }}>
                        <div style={{ marginLeft: '-5px', marginRight: '-5px', backgroundColor: '#f0f2f5' }}>
                            <div className={styles['chart-row']}>
                                <div className={styles['chart-container']} style={{ width: '310px', height: '277px', marginTop: '0px' }}>
                                    <div>
                                ...
                                <div>
                                    <Timeline>
                                        <Timeline.Item style={{ paddingBottom: '0px' }} className={styles['no-padding-bottom-chart']}>
                                            <div className={styles['chart-container']} style={{ width: '258px', height: '115px', marginLeft: '-6px', marginTop: '3px' }}>
                                                    ...
                                                    <div>
                                                        <PieChart
                                                            ...
                                                            <Pie
                                                                ...
                                                                activeIndex={0}>
                                                                {
                                                                    MICRO_SHARE.map((entry, index) => <Cell key={`cell_${(index + 1)}`} fill={entry.color} />)
                                                                }
                                                            </Pie>
                                                        </PieChart>
                                                    </div>
                                                            ...
                                                            <div style={{ display: 'flex', flexDirection: 'column', marginLeft: '10px', justifyContent: 'center' }}>
                                                                {
                                                                    MICRO_SHARE.map(
                                                                        (item, index) =>
                                                                            <div key={(index + 1)} className={styles['color-dot-container']}>
    ...
    handleRowKey = (record, index) => {        
        return `${(record && record.RowNo)}_${index + 1}`
    }

}

export default connect((state) => ({}), {})(SaleSummaryChart)